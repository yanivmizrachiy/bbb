...
cover = f"""<div class="cover">
  <div class="band">
    ...
    <div class="sub">אוסף שאלות להדפסה · ביטויים, משוואות וגרפים</div>
    <div class="meta">משתנים וביטויים · שוויון וכינוס איברים · משוואות ופתרונן · קריאת גרף ברביע I</div>
  </div>
  <div class="toc">
    <h2>תוכן העניינים</h2>
    <ol>{toc}</ol>
  </div>
  <div class="foot">דף עבודה זה הופק מתוך מסמך \"אלגברה לכיתה ז\" · השאלות בלבד, בעיצוב מחודש להדפסה</div>
</div>"""
