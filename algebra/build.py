...
sheets = "".join(f'<div class="sheet" id="p{i+1}"><img src="assets/pages/p{i+1:03d}.png?v={ts}" loading="lazy" alt="עמוד {i+1}"><div class="pgn">עמוד {i+1} / {npages}</div></div>' for i in range(npages))
