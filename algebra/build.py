...
def blank(w=64):
    """Inline boxed blank — instead of a bare '___' inside a sentence."""
...
Q(1, "קישוריות עם גאומטריה — היקף משולש שווה־צלעות:"
  + parts([("א.", "מהו היקפו של משולש שווה־צלעות שאורך צלעו " + L("5") + " ס\"מ? ושל אחד שאורך צלעו " + L("7") + " ס\"מ?"
            + ansval("צלע " + L("5") + " ס\"מ — היקף:", "ס\"מ", 70)
            + ansval("צלע " + L("7") + " ס\"מ — היקף:", "ס\"מ", 70), 0),
           ("ב.", "מהו היקפו של משולש שווה־צלעות שאורך צלעו " + L("m") + " ס\"מ? (כתבו ביטוי אלגברי)", 1)]))

Q(2, "מחיר ליטר דלק הוא " + L("7") + " שקלים."
  + parts([("א.", "מהי העלות של כל אחת מהכמויות? מלאו את הטבלה:"
            + table(["כמות הדלק", L("20") + " ליטרים", L("30") + " ליטרים", L("b") + " ליטרים", L("b = 40")],
                    [["<b>העלות (בשקלים)</b>", blank(52), blank(52), blank(64), blank(52)]]), 0),
           ("ב.", "בלילה (בין " + L("21:00") + " ל־" + L("06:00") + ") יש עמלה קבועה של " + L("2") + " שקלים לכל מילוי. רשמו ביטוי לעלות של " + L("b") + " ליטרים בלילה, וחשבו עבור " + L("b=40") + "." + lines(1)
            + ansval("העלות בלילה עבור " + L("b = 40") + ":", "שקלים", 70), 0)]))

Q(3, "לפניכם שלושת האיברים הראשונים (משמאל לימין) בסדרה של קבוצות סימנים:"
  + fig(C.seq_a3(), w=58)
  + parts([("א.", "כמה סימנים יש בכל אחד מהאיברים המוצגים?" + '<div class="ansrow">' + blank(46) * 3 + '</div>', 0),
           ("ב.", "הציעו המשך לסדרה: כתבו שלושה איברים עוקבים." + '<div class="ansrow">' + blank(46) * 3 + '</div>', 0),
           ("ג.", "בהנחה שהאיברים הם " + L("3, 5, 7, 9, 11, 13") + ", מהו האיבר ה־" + L("9") + " בסדרה?"
            + ansval("האיבר ה־" + L("9") + ":", "", 70), 0),
           ("ד.", "מהו האיבר ה־" + L("58") + "? מהו האיבר ה־" + L("1000") + "?"
            + ansval("האיבר ה־" + L("58") + ":", "", 70) + ansval("האיבר ה־" + L("1000") + ":", "", 70), 0),
...
Q(5, "הגובה של מגדל הבנוי מ־" + L("4") + " כוסות הוא " + L("20") + " ס\"מ, והגובה של מגדל מ־" + L("6") + " כוסות הוא " + L("26") + " ס\"מ."
  + fig(C.cups_two(), w=52)
  + parts([("א.", "בכמה ס\"מ גדל גובה המגדל כאשר מוסיפים כוס אחת?" + ansval("", "ס\"מ", 70), 0),
...
Q(6, "ליובל יש פי שניים ספרים מאשר לעמית. לדוד יש שישה ספרים יותר מאשר לעמית. כמה ספרים יש לשלושתם יחד, אם לעמית יש:"
  + parts([("א.", L("5") + " ספרים" + ansval("סה\"כ:", "", 70), 0),
           ("ב.", L("10") + " ספרים" + ansval("סה\"כ:", "", 70), 0),
           ("ג.", L("50") + " ספרים" + ansval("סה\"כ:", "", 70), 0),
           ("ד.", L("x") + " ספרים (ביטוי אלגברי)", 1)]))

Q(7, "צלע אחת של מלבן ארוכה פי " + L("3") + " מהצלע השנייה."
  + parts([("א.", "מהו היקף המלבן עבור כל אחד מאורכי הצלע הקצרה? מלאו את הטבלה:"
            + table(["אורך הצלע הקצרה", L("5") + " ס\"מ", L("20") + " ס\"מ", L("35") + " ס\"מ", L("a") + " ס\"מ"],
                    [["<b>היקף המלבן</b>", blank(52), blank(52), blank(52), blank(60)]]), 0),
...
Q(11, "מהם חמשת האיברים הראשונים של הסדרה שבמקום ה־" + L("n") + " שלה נמצא המספר " + L("3·n − 1") + "?"
  + '<div class="ansrow">' + blank(48) * 5 + '</div>')

Q(12, "הציבו בביטוי " + L("21 − 3a") + " את הערכים " + L("3, 4, 5") + " במקום המשתנה " + L("a") + ", וחשבו את ערכו המספרי בכל מקרה."
  + ansval("עבור " + L("a = 3") + ":", "", 70) + ansval("עבור " + L("a = 4") + ":", "", 70) + ansval("עבור " + L("a = 5") + ":", "", 70))

Q(13, "הציבו את המספרים " + L("1, 2, 3") + " במקום המשתנה " + L("t") + " בביטוי " + L("4t + 2 − 3t + 1") + "."
  + ansval("עבור " + L("t = 1") + ":", "", 70) + ansval("עבור " + L("t = 2") + ":", "", 70) + ansval("עבור " + L("t = 3") + ":", "", 70))

Q(14, "התאימו לכל <b>תיאור מילולי</b> את הביטוי האלגברי המתאים (רשמו את האות המתאימה במשבצת):"
  + parts([("1.", "הוסיפו " + L("2") + " ל־" + L("a") + " " + blank(40), 0),
           ("2.", "חסרו " + L("2") + " מ־" + L("a") + " " + blank(40), 0),
           ("3.", "כפלו את " + L("a") + " ב־" + L("2") + " " + blank(40), 0),
           ("4.", "חלקו את " + L("a") + " ב־" + L("2") + " " + blank(40), 0),
           ("5.", "כפלו את " + L("a") + " בעצמו " + blank(40), 0)])
  + "<p><b>הביטויים:</b></p>"
  + mc([("א.", L("a + 2")), ("ב.", L("a − 2")), ("ג.", L("2a")), ("ד.", M("\\frac{a}{2}")),
        ("ה.", L("a²")), ("ו.", L("2 − a")), ("ז.", M("\\frac{2}{a}"))]))
...
Q(17, "התאימו כל ביטוי לתיאור המילולי (רשמו את האות המתאימה במשבצת):"
  + parts([("i.", "הציון של נבו במבחן גבוה מהציון של חן ב־" + L("20") + " נקודות. " + blank(40), 0),
           ("ii.", "הלכנו " + L("10") + " ק\"מ, ואז המשכנו באופנוע במהירות " + L("20") + " קמ\"ש במשך זמן מה. " + blank(40), 0),
           ("iii.", "מחיר העגבניות התייקר ב־" + L("3") + " ₪ לק\"ג, וקניתי " + L("2") + " ק\"ג. " + blank(40), 0)])
  + "<p><b>הביטויים:</b></p>"
  + mc([("א.", L("t − 20")), ("ב.", L("20 + 10t")), ("ג.", L("2(t + 3)"))]))
...
Q(20, "ידוע כי " + L("a + b = 5") + ". חשבו:"
  + parts([("א.", L("(a + b)·2") + ansval("=", "", 70), 0), ("ב.", L("2a + 2b − 4") + ansval("=", "", 70), 0),
           ("ג.", L("a + b + 5") + ansval("=", "", 70), 0), ("ד.", L("(a + b)(a + b)") + ansval("=", "", 70), 0)]))

Q(21, "נתון ביטוי אלגברי " + L("5b − 1.5c") + ". מהו ערכו עבור:"
  + parts([("א.", L("b = 5, c = 1.5") + ansval("הערך:", "", 70), 0), ("ב.", L("b = 2, c = −3") + ansval("הערך:", "", 70), 0),
           ("ג.", L("b = −4, c = 3.75") + ansval("הערך:", "", 70), 0), ("ד.", L("b = 0, c = −9") + ansval("הערך:", "", 70), 0)]))

Q(22, "נתון ביטוי אלגברי " + L("h³ + 4k² − 4") + ". מהו ערכו עבור:"
  + parts([("א.", L("h = 2, k = 1.5") + ansval("הערך:", "", 70), 0), ("ב.", L("h = −2, k = 3") + ansval("הערך:", "", 70), 0),
           ("ג.", L("h = −1, k = 2") + ansval("הערך:", "", 70), 0), ("ד.", L("k = 0, h = 4") + ansval("הערך:", "", 70), 0)]))

Q(23, "מהו הביטוי המייצג את היקף המצולע שבסרטוט? נתון: " + L("b = 11") + " ו־" + L("c = 16") + " — חשבו את ההיקף."
  + fig(C.polygon_perim(), w=42) + lines(1) + ansval("ההיקף =", "ס\"מ", 70))
...
Q("מסכמת 1", "אריאל הפיל כדור מראש צוק, והכדור הגיע לקרקע " + L("3") + " שניות לאחר מכן. הגובה (במטרים) מקורב בנוסחה "
  ...
  + parts([("(1)", "מהו בערך הגובה של הצוק?" + mc([("א.", "15 מטר"), ("ב.", "30 מטר"), ("ג.", "45 מטר"), ("ד.", "225 מטר")]), 0),
           ("(2)", "אריאל הפיל כדור זהה מראש צוק אחר, והכדור הגיע לקרקע לאחר " + L("2") + " שניות. איזה צוק גבוה יותר? ומהו הפרש הגבהים?"
            + mc([("", "הצוק הראשון"), ("", "הצוק האחר")]) + ansval("הפרש הגבהים:", "מ'", 70), 1)]))
...
Q("מסכמת 2", "מגזין רכב מדרג חמש מכוניות לפי ארבעה מאפיינים — בטיחות " + L("(S)") + ", יעילות דלק " + L("(F)")
  ...
  + parts([("א.", "הציון הכולל מחושב לפי " + L("3·S + F + E + T") + ". חשבו את הציון הכולל של \"Ca\"."
            + ansval("הציון הכולל של \"Ca\":", "", 70), 0),
...
Q(1, "לפניכם ארבע התמונות הראשונות בסדרה של נקודות:"
  + fig(C.dotpattern(), w=66)
  + "דוד, שרית ואוסנת הציעו ביטויים למספר הנקודות בתמונה שמספרה הסידורי " + L("n") + ":"
  + table(["התלמיד/ה", "הביטוי המוצע"],
          [["<b>דוד</b>", L("4(n−1)+1")],
           ["<b>שרית</b>", L("2n−1+2(n−1)")],
           ["<b>אוסנת</b>", L("2(2n−1)−1")]])
  + parts([("א.", "בדקו כל ביטוי בעזרת הצבה. מי הציג ביטוי שמתאר נכון את מספר הנקודות בכל תמונה?"
            + ansval("תשובה:", "", 150), 0),
           ("ב.", "האם הצבת אותו ערך של " + L("n") + " בשלושת הביטויים נותנת תמיד אותה תוצאה מספרית? הסבירו מדוע.", 2)]))
...
Q(2, "בסרטוט חלקת אדמה מלבנית ובתוכה בית מלבני; מסביב גדל דשא. אורך הבית הוא חצי מאורך החלקה, ורוחבו חצי מרוחב החלקה."
  ...
  + parts([("א.", "נבו: \"אחסר את שטח הבית משטח החלקה\". מהו הביטוי שאליו הגיע?" + lines(1)
            + "האם צדק?" + mc([("", "כן"), ("", "לא")]), 0),
           ("ב.", "אלה: \"שטח הבית הוא רבע מהחלקה, לכן אכפול את שטח החלקה ב־" + L("0.75") + "\". מהו הביטוי שלה?" + lines(1)
            + "האם צדקה?" + mc([("", "כן"), ("", "לא")]), 0),
           ("ג.", "האם לכל ערך של " + L("a") + " שני הביטויים שווים?" + mc([("", "כן"), ("", "לא")]), 0)]))

Q(3, "במבצע ירד מחיר המנגו ב־" + L("2") + " ₪ לק\"ג. הדס ואלה קונות " + L("5") + " ק\"ג כל אחת. נסמן ב־" + L("m") + " את המחיר המקורי לק\"ג."
  + table(["הקונה", "הטענה"],
          [["<b>הדס</b>", "התשלום הוא " + L("5(m−2)")],
           ["<b>אלה</b>", "ההוזלה היא " + L("10") + " ₪, לכן " + L("5m−10")]])
  + "מי צודקת? הסבירו." + ansval("שם:", "", 90) + lines(2))

Q(4, "האם הביטויים " + L("a·a") + " ו־" + L("a²") + " הם ביטויים שווים? הסבירו."
  + mc([("", "כן"), ("", "לא")]) + lines(1))
ENDSEC()
...
Q(1, "לפניכם מלבן המורכב משני חלקים. דני ויוסי מצאו את שטחו בדרכים שונות — מי צודק? אולי שניהם?"
  + fig(C.rect_two(), w=50)
  + parts([("א.", "יוסי: " + L("2x + 3x = (x+x) + (x+x+x) = 5x") + mc([("", "נכון"), ("", "לא נכון")]), 1),
           ("ב.", "דני: " + L("2x + 3x = (2+3)x = 5x") + mc([("", "נכון"), ("", "לא נכון")]), 1)]))

Q(2, "סרגל עולה " + L("k") + " שקלים ועט עולה " + L("m") + " שקלים. התאימו לכל תיאור מילולי את הביטוי האלגברי המתאים (רשמו את האות המתאימה במשבצת):"
  + parts([("1.", "המחיר של " + L("5") + " עטים " + blank(40), 0),
           ("2.", "המחיר של " + L("5") + " סרגלים ו־" + L("5") + " עטים " + blank(40), 0),
           ("3.", "ההפרש בין מחיר " + L("5") + " עטים לבין מחיר " + L("5") + " סרגלים " + blank(40), 0),
           ("4.", "העודף מ־" + L("50") + " שקלים ששולמו עבור " + L("5") + " עטים " + blank(40), 0)])
  + "<p><b>הביטויים:</b></p>"
  + mc([("א.", L("5m")), ("ב.", L("5(k + m)")), ("ג.", L("5m − 5k")),
        ("ד.", L("50 − 5m")), ("ה.", L("5k")), ("ו.", L("5k − 5m"))]))
...
Q(1, "בדקו בעזרת הצבה מי מהערכים הוא פתרון של המשוואה ומי איננו:"
  + parts([("א.", L("x − 10 = 5") + " — האם " + L("x = 5") + "?" + mc([("", "כן"), ("", "לא")]), 1),
           ("ב.", L("4x − 2 = 2x + 2") + " — האם " + L("x = 1") + "?" + mc([("", "כן"), ("", "לא")]), 1),
           ("ג.", L("4x − 2 = 10 − x") + " — האם " + L("x = 2") + "?" + mc([("", "כן"), ("", "לא")]), 1),
           ("ד.", L("2x + 6 = 5x") + " — האם " + L("x = 2") + "?" + mc([("", "כן"), ("", "לא")])
            + "האם " + L("x = 3") + "?" + mc([("", "כן"), ("", "לא")]), 1),
           ("ה.", L("3x − 6 = 7x") + " — האם " + L("x = 3") + "?" + mc([("", "כן"), ("", "לא")]), 1),
           ("ו.", L("7x − 6 = 3x") + " — האם " + L("x = 2") + "?" + mc([("", "כן"), ("", "לא")])
            + "האם " + L("x = 1") + "?" + mc([("", "כן"), ("", "לא")]), 1)]))

Q(2, "מה צריך לכתוב במשבצת במשוואה " + L("x³ + x = □") + " כדי שפתרון המשוואה יהיה " + L("1") + "?"
  + ansval("במשבצת יש לכתוב:", "", 70))
...
Q(6, "בית ספר קנה " + L("18") + " כדורים שמחירם זהה. אילו התייקר כל כדור ב־" + L("6") + " ש\"ח, היה אפשר לקנות באותו סכום רק " + L("15") + " כדורים."
  + parts([("א.", "סמנו ב־" + L("x") + " את מחיר הכדור המקורי (לפני ההתייקרות) ובנו משוואה.", 1),
           ("ב.", "פתרו את המשוואה והסבירו את דרך הפתרון.", 2)]))

Q(7, "אילנה קנתה " + L("5") + " חטיפי תמרים, " + L("4") + " חפיסות מסטיק ו־" + L("7") + " חטיפי אגוזים."
  + parts([("•", "מחיר חפיסת מסטיק זול ב־" + L("0.5") + " ש\"ח ממחיר חטיף תמרים.", 0),
           ("•", "מחיר חטיף אגוזים יקר ב־" + L("3") + " ש\"ח ממחיר חטיף תמרים.", 0),
           ("•", "אילנה שילמה בסך הכול " + L("75") + " ש\"ח.", 0)])
  + "סמנו ב־" + L("x") + " ₪ את מחיר חטיף התמרים ובנו משוואה. בחרו את הפתרון הנכון ונמקו."
  + mc([("(1)", "5 ש\"ח"), ("(2)", "−4 ש\"ח"), ("(3)", "3.5 ש\"ח"), ("(4)", "0.2 ש\"ח")]))

Q(8, "רוכב אופניים עלה מעפולה אל פסגת הר תבור, וחזר מהפסגה אל עפולה באותה הדרך."
  + parts([("•", "בעלייה רכב במהירות קבועה של " + L("12") + " קמ\"ש.", 0),
           ("•", "בדרך חזרה רכב במהירות קבועה של " + L("36") + " קמ\"ש.", 0),
           ("•", "בסך הכול, הלוך וחזור, נמשכה הרכיבה " + L("2") + " שעות.", 0)])
  + "סמנו ב־" + L("t") + " את זמן העלייה לפסגה (בשעות), בנו משוואה ופתרו. בחרו את הפתרון הנכון ונמקו."
...
Q(1, "פתרו בעל פה, בעזרת שיקול דעת חישובי:"
  + parts([("א.", L("3a = 11 + 4") + ansval(L("a ="), "", 70), 0),
           ("ב.", L("b − 1 = 7 + 3") + ansval(L("b ="), "", 70), 0),
           ("ג.", L("2(c − 5) = 18") + ansval(L("c ="), "", 70), 0)]))
...
Q(7, "נתונות שתי משקולות. האחת כבדה פי " + L("2") + " מהאחרת, ומשקלן הכולל " + L("13.5") + " ק\"ג. מה משקל המשקולת הקלה?"
  + lines(2) + ansval("משקל המשקולת הקלה:", "ק\"ג", 70))

Q(8, "במשולש ישר־זווית, זווית חדה אחת קטנה ב־" + L("20°") + " מהזווית החדה האחרת. מצאו את גודל הזוויות."
  + lines(2) + ansval("הזווית הקטנה:", "°", 60) + ansval("הזווית הגדולה:", "°", 60))

Q(9, "דן גדול מיואב ב־" + L("6") + " שנים. לפני " + L("4") + " שנים היה גילו של דן פי " + L("2") + " מגילו של יואב. בני כמה דן ויואב כיום?"
  + lines(2) + ansval("גיל דן:", "", 60) + ansval("גיל יואב:", "", 60))

Q(10, "בשתי תחנות דלק אלה מחירי התדלוק בלילה:"
  + table(["התחנה", "מחיר לליטר (₪)", "עמלת לילה (₪)"],
          [["<b>תחנה א'</b>", L("6.45"), L("4")],
           ["<b>תחנה ב'</b>", L("6.55"), L("2")]])
  + "לאיזו כמות דלק עלות התדלוק בלילה בשתי התחנות שווה?"
  + lines(2) + ansval("כמות הדלק:", "ליטרים", 70))
...
Q(11, "אנה ודן יוצאים באותו הזמן משני מקומות שהמרחק ביניהם " + L("14") + " ק\"מ, וצועדים זה לקראת זה. אנה צועדת במהירות קבועה של " + L("4") + " קמ\"ש, ודן במהירות " + L("6") + " קמ\"ש. בנו משוואה ומצאו כעבור כמה זמן הם ייפגשו."
  + fig(C.seg_walk(), w=56) + lines(2) + ansval("הזמן עד המפגש:", "שעות", 70))
...
Q(1, "עלות החנייה בחניון היא " + L("10") + " ₪ לשעה הראשונה, ועוד " + L("3.50") + " ₪ לכל רבע שעה נוספת."
  ...
  + parts([("א.", "מהי עלות החנייה לשעתיים מלאות? ול־" + L("3") + " שעות מלאות?"
            + ansval("לשעתיים:", "₪", 60) + ansval("ל־" + L("3") + " שעות:", "₪", 60), 0),
           ("ב.", "השלימו את הנקודה המתאימה לתשלום עבור " + L("3.5") + " שעות חנייה.", 0),
           ("ג.", "מהו התשלום עבור חנייה של " + L("4") + " שעות?" + ansval("התשלום:", "₪", 60), 0)]))
...
Q(2, "הגרף מציג את ההישג הממוצע של תלמידי ישראל במבחן בינלאומי (טווח אפשרי " + L("200") + "–" + L("800") + "):"
  ...
  + parts([("א.", "מה היה ההישג הממוצע בשנת " + L("2011") + "?" + ansval("ההישג הממוצע:", "", 70), 0),
           ("ב.", "באיזו שנה היה ההישג " + L("511") + "?" + ansval("השנה:", "", 70), 0),
           ("ג.", "באיזו שנה היה ההישג הגבוה ביותר?" + ansval("השנה:", "", 70), 0)]))
...
Q(3, "הגרף מציג את שטח הריבוע בהתאם לאורך הצלע (בס\"מ):"
  ...
  + parts([("א.", "כאשר אורך הצלע " + L("1.5") + " ס\"מ, מהו שטח הריבוע?" + ansval("השטח:", "סמ\"ר", 60), 0),
           ("ב.", "מה יכול להיות אורך הצלע אם השטח בין " + L("3") + " ל־" + L("7") + " סמ\"ר? (לפי הנקודות בגרף)"
            + ansval("אורך הצלע:", "ס\"מ", 60), 0),
           ("ג.", "נסמן ב־" + L("x") + " את אורך הצלע וב־" + L("y") + " את השטח. רשמו " + L("y = ……") + ".", 1)]))

Q(4, "בשתי ספריות שכונתיות נבדק מספר הספרים:"
  + table(["הספרייה", "ספרים כיום", "רכישה בכל שנה"],
          [["<b>תלפיות</b>", L("1300"), L("100")],
           ["<b>ארנונה</b>", L("800"), L("150")]])
  + fig(C.points_plot([(0,1300),(2,1500),(4,1700),(6,1900),(8,2100),(10,2300)],
        ...
        "תלפיות (כחול) · ארנונה (אדום)", w=58)
  + parts([("א.", "התאימו כל סדרת נקודות לספרייה המתאימה.", 1),
           ("ב.", "כמה ספרים היו בארנונה כעבור " + L("3") + " שנים?" + ansval("מספר הספרים:", "", 70), 0),
           ("ג.", "כעבור כמה שנים יהיו " + L("1400") + " ספרים בארנונה? ובתלפיות?"
            + ansval("בארנונה: כעבור", "שנים", 60) + ansval("בתלפיות: כעבור", "שנים", 60), 0),
           ("ד.", "סמנו ב־" + L("t") + " את מספר השנים ורשמו ביטוי אלגברי למספר הספרים בכל ספרייה.", 1),
           ("ה.", "כעבור כמה שנים יהיה בשתי הספריות אותו מספר ספרים?" + ansval("כעבור", "שנים", 60), 0),
           ("ו.", "באיזו ספרייה יהיו יותר ספרים כעבור " + L("15") + " שנה?" + mc([("", "תלפיות"), ("", "ארנונה")]), 0)]))

Q(5, "במשתלה אפשר לקנות פרחים בשתי דרכים:"
  + parts([("•", "<b>קנייה בחנות:</b> " + L("7.5") + " ₪ לפרח.", 0),
           ("•", "<b>קנייה באתר:</b> " + L("5") + " ₪ לפרח, בתוספת " + L("50") + " ₪ משלוח.", 0)])
  ...
  + parts([("א.", "מלאו את הטבלה (תשלום בכל דרך).", 0),
           ("ב.", "החל מאיזה מספר פרחים זול יותר לקנות באתר? נמקו." + ansval("מספר פרחים:", "", 70), 2)]))
