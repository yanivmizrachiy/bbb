...
האתר יהיה חי, נטען מ-PostgreSQL אמיתי. כל push לריפו יפרוס אוטומטית מחדש.

> הערה: תמונות העמודים נטענות כרגע מהאתר הסטטי הקיים ב-GitHub Pages (כתובת
> ציבורית יציבה), כך שאין צורך להעלות נכסים. המלל/התוכן לא משתנה — המסד מטא-דאטה בלבד.
